...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <style>
            body {
                ...
                background-image: url('https://c1.wallpaperflare.com/preview/403/473/138/shop-clothes-clothing-shopping-mall.jpg');
    ...
    <h3 class="float-md-start mb-0" style="color:#b78b20"><b><i>Next</i></b></h3>
