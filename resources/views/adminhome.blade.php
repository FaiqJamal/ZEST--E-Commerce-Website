        ...
        <table class="table table-striped table-sm">
          ...
          @foreach($men_details as $men)
                                  <tr>
                                      ...
                                      <td >
                                     <img src="{{url('images/'.$men->picture)}}" >
                                      </td>
        </tr>                   
                                <?php
                                    $counter++;
      ...
      <div class="table-responsive">
        <table class="table table-striped table-sm">
          ...
          <?php
            $counter=1;
            ?>
          @foreach($women_details as $women)
                                  <tr>
                                    <td>
                                  <?php
                                        echo $counter;
                                      ...
                                      <td >
                                      <img src="{{url('images/'.$women->picture)}}"> 
                                      </td>
        </tr>
        <?php
                                    $counter++;
        ...
        <table class="table table-striped table-sm">
          ...
          @foreach($boys_details as $boys)
                                  ...
                                  <?php
                                      ...
                                      <td >
                                      <img src="{{url('images/'.$boys->picture)}}">  
                                      </td>
        </tr>
        <?php
                                    $counter++;
      ...
      <div class="table-responsive">
        <table class="table table-striped table-sm">
          ...
          <?php
            $counter=1;
            ?>
          @foreach($girls_details as $girls)
                                  <tr>
                                  <td>
                                  <?php
                                        echo $counter;
                                      ...
                                      <td >
                                      <img src="{{url('images/'.$girls->picture)}}"> 
                                      </td>
        </tr>
        <?php
                                    $counter++;
