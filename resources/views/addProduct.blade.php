...
<div class="container-fluid">
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <form class="row g-3" method="POST" action="{{ route('addProduct') }}" enctype="multipart/form-data">
      @csrf
  <div class="col-md-6">
  ...
  <div class="col-md-2">
    <label for="small" class="form-label">Small Size Quantity</label>
    <input type="int" class="form-control" id="small" name="small" >
    @if ($errors->has('small'))
    <span class="text-danger">{{ $errors->first('small') }}</span>
    @endif
  </div>
  <div class="col-md-2">
    <label for="medium" class="form-label">Medium Size Quantity</label>
    <input type="int" class="form-control" id="medium" name="medium" >
    @if ($errors->has('medium'))
    <span class="text-danger">{{ $errors->first('medium') }}</span>
    @endif
  </div>
  <div class="col-md-2">
    <label for="large" class="form-label">Large Size Quantity</label>
    <input type="int" class="form-control" id="large" name="large" >
    @if ($errors->has('large'))
    <span class="text-danger">{{ $errors->first('large') }}</span>
    @endif
  </div>
  
  <div class="col-md-2">
    <label for="categoryId" class="form-label">Category ID</label>
    <input type="int" class="form-control" id="categoryId" name="categoryId" >
